...
/// CompanyController
/// </summary>
public class CompanyController : SurveyApiController
{
    /// <summary>
    ...
    public CompanyController(ISurveyService service, ILogger<CompanyController> logger) : base(service, logger)
    {
    }
